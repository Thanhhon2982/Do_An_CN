...
$data =
    [
        "name" => postInput("name"),//chuyển tên có dấu thành ký tự có gạch ngang 
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {   //Khai báo mảng data từ dtbase.php hàm insert
    ...
    if (empty($error)) {   //câu lênh cho upload file
        ...
        if ($id_insert > 0) {   //đưa dữ liệu đường dẫn file uploads

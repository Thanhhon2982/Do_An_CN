...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            Danh sách sản phẩm <a href="/admin/modules/product/add.php" class="btn btn-info">Thêm mới</a>
        </h1>
        <ol class="breadcrumb">
            <li>
                <i class="fa fa-dashboard"></i>  <a href="/admin/index.php">Bảng điều khiển</a>
            </li>
            <li class="active">
...
<div class="col-sm-8">
                            <form class="navbar-form navbar-right" action="/admin/modules/search/index.php" method="GET">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center";><a href="/admin/modules/product/edit.php?id=<?php echo $row['id'];?>"><img width="20" src="../../../image/update.png"></a></td>
                        <td align="center";>
                            <a href="/admin/modules/product/delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Bạn thực sự muốn xóa nó?');">

            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>             
                            <a class="btn btn-xs btn-info" href="/admin/modules/users/edit.php?id=<?php echo $row['id'];?>"><i class="fa fa-refresh" style="color: #fff;"></i>Chỉnh sửa</a>
                            <a class="btn btn-xs btn-danger" href="/admin/modules/users/delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Bạn thực sự muốn xóa nó?');"><i class="fa fa-remove" style="color: #fff;"></i> Xóa</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>

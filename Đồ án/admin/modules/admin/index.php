...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            Danh sách Admin <a href="/admin/modules/admin/add.php" class="btn btn-info">Thêm mới</a>
        </h1>
        <ol class="breadcrumb">
            <li>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center";><a href="/admin/modules/admin/edit.php?id=<?php echo $row['id'];?>"><img width="20" src="../../../image/update.png"></a></td>
                        <td align="center";>

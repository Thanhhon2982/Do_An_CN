            ...
            <table class="table table-bordered table-hover">
                ...
                <?php //in danh sách 
                    ...
                    <tr>
                        ...
                        <td>
                            <a style="margin-top: 5px;" href="/admin/transaction/donhang.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-info"><i class="fa fa-refresh" style="color: #fff;"></i> Chi tiết</a>
                            <a style="margin-top: 5px;" href="/admin/transaction/in.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-success"><i class="fa fa-refresh" style="color: #fff;"></i> In hóa đơn</a>
                            <a style="margin-top: 5px;" class="btn btn-xs btn-danger" href="/admin/transaction/delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Bạn thực sự muốn xóa nó?');"><i class="fa fa-remove" style="color: #fff;"></i> Xóa</a>
                        </td>
                    </tr>
                    <?php $num++; endforeach ?>
                </tbody>

...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            Danh sách Pannel <a href="/admin/setting/addpannel.php" class="btn btn-info">Thêm mới</a>
        </h1>
        <ol class="breadcrumb">
            <li>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>             
                            <a href="/admin/setting/editpannel.php?id=<?php echo $row['id'];?>" class="btn btn-xs btn-info" href="edit.php?id=<?php echo $row['id'];?>"><i class="fa fa-refresh" style="color: #fff;"></i>Chỉnh sửa</a>
                        </td>
                        <td>
                        	<a class="btn btn-xs btn-danger <?php echo $row['sum']==1?"disabled":'' ?>" href="/admin/setting/dellpannel.php?id=<?php echo $row['id'];?>"><i class="fa fa-remove" style="color: #fff;"></i> Xóa</a>
                        </td>
                    </tr>
